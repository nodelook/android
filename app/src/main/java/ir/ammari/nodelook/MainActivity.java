...
public class MainActivity extends Activity {
    private static final List<SiteInfo> sites = new ArrayList<>() {{
        ...
        add(new SiteInfo("[Social Media] Bale: WebSocket Signaling Server 1", "meet-gwbm1.ble.ir/", "OK"));
        add(new SiteInfo("[Social Media] Bale: WebSocket Signaling Server 2", "meet-gwbm2.ble.ir/", "OK"));
        add(new SiteInfo("[Social Media] Bale: WebSocket Signaling Server 3", "meet-gwbm3.ble.ir/", "OK"));
        add(new SiteInfo("[Social Media] Bale: WebSocket Signaling Server 4", "meet-gwbm4.ble.ir/", "OK"));
        add(new SiteInfo("[Social Media] Bale: WebSocket Signaling Server 5", "meet-gwbm5.ble.ir/", "OK"));
        add(new SiteInfo("[Social Media] Bale: WebSocket Signaling Server 6", "meet-gwbm6.ble.ir/", "OK"));
