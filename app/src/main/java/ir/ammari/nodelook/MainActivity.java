...
public class MainActivity extends Activity {
    private static final List<SiteInfo> sites = new ArrayList<>() {{
        ...
        add(new SiteInfo("[Alpine Repository] China: 024", "mirrors.sjtug.sjtu.edu.cn/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] China: 052", "mirrors.neusoft.edu.cn/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
