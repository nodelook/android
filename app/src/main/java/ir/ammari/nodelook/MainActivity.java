...
public class MainActivity extends Activity {
    private static final List<SiteInfo> sites = new ArrayList<>() {{
        ...
        add(new SiteInfo("[Social Media] Bale: WebSocket Signaling Server 1", "https://meet-gwbm1.ble.ir/", "OK"));
        add(new SiteInfo("[Social Media] Bale: WebSocket Signaling Server 2", "https://meet-gwbm2.ble.ir/", "OK"));
        add(new SiteInfo("[Social Media] Bale: WebSocket Signaling Server 3", "https://meet-gwbm3.ble.ir/", "OK"));
