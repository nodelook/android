...
public class MainActivity extends Activity {
    private static final List<SiteInfo> sites = new ArrayList<>() {{
        ...
        add(new SiteInfo("[Alpine Repository] 002", "mirror.yandex.ru/mirrors/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 004", "mirror1.hs-esslingen.de/pub/Mirrors/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 006", "mirror.fel.cvut.cz/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 007", "alpine.mirror.far.fi/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 012", "ftp.halifax.rwth-aachen.de/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 013", "mirrors.tuna.tsinghua.edu.cn/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 014", "mirrors.ustc.edu.cn/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 015", "mirrors.nju.edu.cn/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 016", "mirror.lzu.edu.cn/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 023", "mirror.math.princeton.edu/pub/alpinelinux/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 024", "mirrors.sjtug.sjtu.edu.cn/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 028", "ap.edge.kernel.org/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 034", "mirror.ette.biz/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 037", "foobar.turbo.net.id/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 038", "alpine.ccns.ncku.edu.tw/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 039", "mirror.dst.ca/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 043", "mirrors.pardisco.co/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 044", "mirrors.aliyun.com/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 052", "mirrors.neusoft.edu.cn/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 056", "ftp.lysator.liu.se/pub/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 061", "mirror.jingk.ai/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 062", "mirror.nyist.edu.cn/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 063", "mirrors.itwrx.org/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 064", "repo.jing.rocks/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 065", "mirror.marwan.ma/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 066", "mirror.pilotfiber.com/alpinelinux/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 069", "mirror.tux.si/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 071", "mirrors.tyo.silicloud.com/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 078", "mirrors.hust.edu.cn/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 079", "ftp2.crifo.org/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 080", "mirror.quantum5.ca/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 084", "mirrors.sdu.edu.cn/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 087", "mirror.maeen.sa/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 088", "plug-mirror.rcac.purdue.edu/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 089", "mirror.saddle.network/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 092", "mirror.krfoss.org/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 094", "us.mirrors.cicku.me/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 098", "alpinemirror.truescape.fi/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 100", "mirror.techrich.hk/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        add(new SiteInfo("[Alpine Repository] 101", "insecure.nluug.nl/pub/os/Linux/distr/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Alpine Repository] 104", "mirror.latigo.net/alpine/latest-stable/releases/x86_64/latest-releases.yaml", "alpine"));
        ...
        add(new SiteInfo("[Social Media] WhatsApp", "www.whatsapp.com/robots.txt", "Disallow"));
        add(new SiteInfo("[Social Media] WhatsApp Web", "web.whatsapp.com/robots.txt", "Disallow"));
        add(new SiteInfo("[Social Media] Facebook", "www.facebook.com/robots.txt", "Disallow"));
